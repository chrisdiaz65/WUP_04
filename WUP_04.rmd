...
```
the numerical data above shows a small difference in students within LT high school and junior college, while Bachelor's almost double in complicity while high schoolers more then quadruple junior collages. Now right now there is going to be some statistical difference but it will be explained into two parts. First  will be running a one way anova to hopefully get our hands on some statistical data.
